...
ssh moodcat@moodcat 'rm -r /usr/share/nginx/html/dist' || { echo "Connecting to server failed, exiting"; exit 1; }
echo "Deploying new dist/"
scp -r dist moodcat@moodcat:/usr/share/nginx/html/dist/ > /dev/null
echo "Done."
exit 0
